...
branch=10
aosp_version=QQ2A.200405.005 # version to use for build id and tag
aosp_version_real=QQ2A.200405.005 # real base version
...
declare -A kernels=(
    [google_wahoo]=android-10.0.0_r0.50 # April 2019
    [google_crosshatch]=android-10.0.0_r0.52 # April 2019
